...
public class AccountRepository {
    private static final String INSERT_ACCOUNT_SQL = "INSERT INTO account (id, account_name, account_type, balance, currency_id, transaction_id) VALUES (?, ?, ?, ?, ?, ?)";
    ...
    private AccountRepository(Connection connection){
